...
INSERT INTO `tbl_user_setting` (`user_setting_id`, `user_id`, `team_id`, `title`, `address`, `phone`, `country_id`,
                                `language_id`, `status`, `avatar`, `created_by`, `created_date`, `updated_by`,
                                `updated_date`, `deleted_by`, `deleted_date`)
VALUES ('1', '1', '1', 'Dev', 'homie', '121142342', '1', '1', 1, NULL, 'Dexx', '2020-02-06 10:10:10', NULL, NULL, NULL,
        NULL);
